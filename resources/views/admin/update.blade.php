                ...
                <div class="w-full">
                    <form action="{{ route('admin.update', $post->id) }}" method="POST" enctype="multipart/form-data">
                        ...
                        <div>
                            ...
                            @if ($post->image)
                                <div class="mb-2">
                                    <img src="{{ asset('storage/postImages/' . $post->image) }}" alt="Current Image"
                        ...
                        <div>
                            ...
                            <input type="text" id="tag" name="tag" value="{{ old('tags', $tagsString) }}"
                                class="p-2 focus:outline-none mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 border border-b-gray-900 focus:ring-indigo-500 dark:bg-gray-700 dark:text-gray-200 dark:border-gray-600"
