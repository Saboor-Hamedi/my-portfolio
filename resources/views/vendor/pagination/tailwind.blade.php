        ...
        <div class="flex justify-center">
            <ul class="flex flex-wrap justify-center rounded-lg border border-stroke dark:border-white/5">
                ...
                @if ($paginator->onFirstPage())
                    <li class="flex items-center justify-center px-2 py-1 text-base font-medium text-gray-400 dark:text-gray-500">
                ...
                @else
                    <li>
                        <a href="{{ $paginator->previousPageUrl() }}" class="flex items-center justify-center border-r border-stroke px-2 py-1 text-base font-medium text-dark hover:bg-gray-200 dark:border-white/10 dark:text-white dark:hover:bg-white/5">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M17.5 9.8125H4.15625L9.46875 4.40625C9.75 4.125 9.75 3.6875 9.46875 3.40625C9.1875 3.125 8.75 3.125 8.46875 3.40625L2 9.96875C1.71875 10.25 1.71875 10.6875 2 10.9688L8.46875 17.5312C8.59375 17.6562 8.78125 17.75 8.96875 17.75C9.15625 17.75 9.3125 17.6875 9.46875 17.5625C9.75 17.2812 9.75 16.8438 9.46875 16.5625L4.1875 11.2188H17.5C17.875 11.2188 18.1875 10.9062 18.1875 10.5312C18.1875 10.125 17.875 9.8125 17.5 9.8125Z" fill="currentColor"/>
                            </svg>
                        </a>
                ...
                @foreach ($elements as $element)
                    ...
                    @if (is_string($element))
                        <li class="flex items-center justify-center px-2 py-1 text-base font-medium text-dark dark:text-white">
                            <span>{{ $element }}</span>
                        </li>
                    @endif
                    ...
                    @if (is_array($element))
                        @foreach ($element as $page => $url)
                            @if ($page == $paginator->currentPage())
                                <li class="flex items-center justify-center border-r border-stroke px-2 py-1 text-base font-medium text-dark bg-gray-200 dark:border-white/10 dark:text-white dark:bg-white/5">
                                    {{ $page }}
                                </li>
                            @else
                                <li>
                                    <a href="{{ $url }}" class="flex items-center justify-center border-r border-stroke px-2 py-1 text-base font-medium text-dark hover:bg-gray-200 dark:border-white/10 dark:text-white dark:hover:bg-white/5">
                                        {{ $page }}
                                    </a>
                                </li>
                            @endif
                ...
                @if ($paginator->hasMorePages())
                    <li>
                        <a href="{{ $paginator->nextPageUrl() }}" class="flex items-center justify-center px-2 py-1 text-base font-medium text-dark hover:bg-gray-200 dark:border-white/10 dark:text-white dark:hover:bg-white/5">
                            <svg width="20" height="21" viewBox="0 0 20 21" fill="none" xmlns="http://www.w3.org/2000/svg">
