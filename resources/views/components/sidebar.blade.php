<aside id="default-sidebar"
    ...
    aria-label="Sidebar">
    <div class="h-full px-3 py-4 overflow-y-auto bg-gray-50 dark:bg-gray-800 text-dark dark__mode">
        <ul class="space-y-2 font-medium dark__mode">
            <li>
            ...
            <li>
                <a href="{{ route('admin.index') }}" class="flex items-center p-2  rounded-lg   group">
            ...
            <li>
                <a href="{{ route('admin.create') }}" class="flex items-center p-2  rounded-lg   group">
                    <svg class="flex-shrink-0 w-5 h-5 text-gray-500 transition duration-75 dark:text-gray-400 group-hover: dark:group-hover:text-white"
